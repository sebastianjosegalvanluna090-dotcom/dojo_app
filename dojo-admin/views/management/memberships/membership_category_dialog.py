...
class MembershipCategoryDialog(QDialog):
    def __init__(self, repo, category=None, parent=None):
        super().__init__(parent)
        self.repo = repo
        self.category = category
        self.setWindowTitle(tr("management.category.membership.new") if category is None else tr("management.category.membership.edit"))
    ...
    def _build_ui(self):
        ...
        self.input_name.setPlaceholderText(tr("management.category.membership.name_placeholder"))
